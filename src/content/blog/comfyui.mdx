...
uv venv --python 3.13
uv pip install -r requirements.txt --extra-index-url https://rocm.nightlies.amd.com/v2/gfx1151
...
Note 2: For Strix Point, the URL becomes `https://rocm.nightlies.amd.com/v2/gfx1150`.
...
Once again, if you are on Strix Point, adjust the URL to `https://rocm.nightlies.amd.com/v2/gfx1150`.
