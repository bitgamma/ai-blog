...
**The goal of this guide is to help you set up the tools and environment for LoRA training.** The actual training process requires experimentation to find settings that work best for your specific use case. These are the steps I followed to train a LoRA for Anima based on my photographic style, with examples from my own training where applicable.
