...
|-----------------|---------|----------|----------|------------------------|
| <Image src={loraTrainingEpoch00} width={180} alt="Epoch 0 (Start) - Training loss and sample images at the beginning of training" /> | <Image src={loraTrainingEpoch06} width={180} alt="Epoch 6 - Early learning phase showing initial style emergence" /> | <Image src={loraTrainingEpoch12} width={180} alt="Epoch 12 - Mid-training with clearer style development" /> | <Image src={loraTrainingEpoch20} width={180} alt="Epoch 20 - Best checkpoint with optimal style quality" /> | <Image src={loraTrainingEpoch30} width={180} alt="Epoch 30 - Overtrained checkpoint with degraded quality" /> |
...
|-----------|--------------|
| <Image src={portrait1Lora} width={340} alt="Portrait 1 with LoRA" /> | <Image src={portrait1NoLora} width={340} alt="Portrait 1 without LoRA" /> |
| <Image src={portrait2Lora} width={340} alt="Portrait 2 with LoRA" /> | <Image src={portrait2NoLora} width={340} alt="Portrait 2 without LoRA" /> |
| <Image src={portrait3Lora} width={340} alt="Portrait 3 with LoRA" /> | <Image src={portrait3NoLora} width={340} alt="Portrait 3 without LoRA" /> |
| <Image src={portrait4Lora} width={340} alt="Portrait 4 with LoRA" /> | <Image src={portrait4NoLora} width={340} alt="Portrait 4 without LoRA" /> |
| <Image src={portrait5Lora} width={340} alt="Portrait 5 with LoRA" /> | <Image src={portrait5NoLora} width={340} alt="Portrait 5 without LoRA" /> |
