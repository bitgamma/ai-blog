---
title: 'Training Klein 9B/4B LoRAs with Musubi-Tuner on AMD Strix Halo'
description: 'A comprehensive guide to train Flux.2 Klein 4B/9B LoRAs on AMD Strix Halo'
pubDate: 'Feb 28 2026'
---
import { Image } from "astro:assets";
import ImageZoom from '../../components/ImageZoom.astro';
import loraTrainingEpoch00 from "../../assets/musubi-tuner/lora-training-epoch00.png";
import loraTrainingEpoch06 from "../../assets/musubi-tuner/lora-training-epoch06.png";
import loraTrainingEpoch12 from "../../assets/musubi-tuner/lora-training-epoch12.png";
import loraTrainingEpoch20 from "../../assets/musubi-tuner/lora-training-epoch20.png";
import loraTrainingEpoch30 from "../../assets/musubi-tuner/lora-training-epoch30.png";
import portrait1Lora from "../../assets/musubi-tuner/portrait1-lora.png";
import portrait1NoLora from "../../assets/musubi-tuner/portrait1-nolora.png";
import portrait2Lora from "../../assets/musubi-tuner/portrait2-lora.png";
import portrait2NoLora from "../../assets/musubi-tuner/portrait2-nolora.png";
import portrait3Lora from "../../assets/musubi-tuner/portrait3-lora.png";
import portrait3NoLora from "../../assets/musubi-tuner/portrait3-nolora.png";
import portrait4Lora from "../../assets/musubi-tuner/portrait4-lora.png";
import portrait4NoLora from "../../assets/musubi-tuner/portrait4-nolora.png";
import portrait5Lora from "../../assets/musubi-tuner/portrait5-lora.png";
import portrait5NoLora from "../../assets/musubi-tuner/portrait5-nolora.png";

This guide walks you through training a custom LoRA (Low-Rank Adaptation) using musubi-tuner on AMD Strix Halo APUs. This guide is for both Flux.2 Klein 4B and 9B. For other models, small adjustments will be needed, and they will be addressed in future guides. These are the steps that I followed to train a LoRA for Klein 9B and 4B based on my photographic style. I will show some examples based on my own LoRA training where applicable.
...
| Start | Early learning | Mid-training | Best checkpoint | Overtrained |

The last checkpoint is clearly overtrained and quality degraded significantly. I used checkpoint 20 instead.

However, I still tested all most promising checkpoints with the distilled model using [ComfyUI](../comfyui/). That's the only way to be sure.
...
Here are some examples images generated using my LoRA. They are generated with the same prompt and seed using Klein 4B. Left is with LoRA, right is without.

| With LoRA | Without LoRA |
|-----------|--------------|
| <ImageZoom src={portrait1Lora} width={340} alt="Portrait 1 with LoRA"/> | <ImageZoom src={portrait1NoLora} width={340} alt="Portrait 1 without LoRA"/> |
| <ImageZoom src={portrait2Lora} width={340} alt="Portrait 2 with LoRA" /> | <ImageZoom src={portrait2NoLora} width={340} alt="Portrait 2 without LoRA" /> |
| <ImageZoom src={portrait3Lora} width={340} alt="Portrait 3 with LoRA" /> | <ImageZoom src={portrait3NoLora} width={340} alt="Portrait 3 without LoRA" /> |
| <ImageZoom src={portrait4Lora} width={340} alt="Portrait 4 with LoRA" /> | <ImageZoom src={portrait4NoLora} width={340} alt="Portrait 4 without LoRA" /> |
| <ImageZoom src={portrait5Lora} width={340} alt="Portrait 5 with LoRA" /> | <ImageZoom src={portrait5NoLora} width={340} alt="Portrait 5 without LoRA" /> |
...
- [My HugginFace](https://huggingface.co/mikkoph)
